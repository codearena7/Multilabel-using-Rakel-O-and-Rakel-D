...
dset = pd.read_csv("db2_scenes.csv")
print(dset.shape)
...
dset_features = dset.iloc[:, 1:295]
features = dset_features.columns
dset_classes = dset.iloc[:, 295:]
...
for mod_dset in model_dset:
    ...
    mod_dset_f = mod_dset.iloc[:, 0:294]
    mod_dset_l = mod_dset.iloc[:, 294:]
